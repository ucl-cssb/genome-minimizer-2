...
def add_config_arguments(parser: argparse.ArgumentParser):
    ...
    # Checkpointing / HF Hub parameters
    ckpt_group = parser.add_argument_group('Checkpointing & HF Hub')
    ckpt_group.add_argument('--checkpoint-every', type=int,
    ...
    # Output parameters. Both --foo / --no-foo carry default=None so that, when
    # neither is passed, ExperimentConfig.from_args() filters them out and the
    # dataclass default wins (instead of argparse's implicit False).
    output_group = parser.add_argument_group('Output Parameters')
    output_group.add_argument('--experiment-name', type=str, help='Experiment name')
    output_group.add_argument('--save-model', dest='save_model', action='store_true',
                              default=None, help='Save model')
    output_group.add_argument('--no-save-model', dest='save_model', action='store_false',
                              default=None, help='Do not save model')
    output_group.add_argument('--generate-plots', dest='generate_plots', action='store_true',
                              default=None, help='Generate plots')
    output_group.add_argument('--no-generate-plots', dest='generate_plots', action='store_false',
                              default=None, help='Do not generate plots')
    output_group.add_argument('--calculate-metrics', dest='calculate_metrics', action='store_true',
                              default=None, help='Calculate metrics')
    output_group.add_argument('--no-calculate-metrics', dest='calculate_metrics', action='store_false',
                              default=None, help='Do not calculate metrics')
    output_group.add_argument('--explore-latent-space', dest='explore_latent_space', action='store_true',
                              default=None, help='Explore latent space')
    output_group.add_argument('--no-explore-latent-space', dest='explore_latent_space', action='store_false',
                              default=None, help='Do not explore latent space')
